...
enum class PlayerSkin(
    ...
    Classic(R.drawable.skin_chicken_1, price = 0),
    Blue(R.drawable.skin_chicken_2, price = 40),
    Red(R.drawable.skin_chicken_3, price = 60),
    Knight(R.drawable.skin_chicken_4, price = 90);
